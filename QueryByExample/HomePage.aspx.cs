    ...
    public partial class HomePage : System.Web.UI.Page
    {
        ...
        protected void ButtonQuery_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                CheckBox checkBoxGroupBy = (CheckBox)GridView1.Rows[i].Cells[3].FindControl("CheckBoxGroupBy");
                CheckBox checkBoxHaving = (CheckBox)GridView1.Rows[i].Cells[4].FindControl("CheckBoxHaving");
                CheckBox checkBoxShow = (CheckBox)GridView1.Rows[i].Cells[5].FindControl("CheckBoxShow");
                Boolean isHaving = false;
                Boolean isGroup = false;



                strBang.Text = GridView1.Rows[i].Cells[7].Text;
                strCot.Text = GridView1.Rows[i].Cells[6].Text;
                ...
                else
                {
                    ...
                    if (checkBoxGroupBy.Checked == true )
                    {
                        if (!groupBy.Equals(""))
                        {
                            groupBy += ", " + columnName;
                ...
                {
                    if (checkBoxHaving.Checked == true)
                    {
                ...
                if (columnName != "" && checkBoxShow.Checked == true)
                {
            ...
            string lastCharacter = mess.Substring(mess.Length - 1);
            if(lastCharacter == ",")
            {
            ...
            if (isFirst == false && isFirstDK == false)
            { // kt xem có ít nhất 1 đk đã tồn tại
            //
            where += " AND ";
            }
        ...
        protected void ButtonReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String connect = "Data Source=DESKTOP-1UGMICG;Initial Catalog=TN_CSDLPT;Integrated Security=True";
